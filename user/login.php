      ...
      <div class="col-xl-10">
        <div class="card rounded-3 text-black">
          <div class="row g-0">
            <div class="col-lg-6">
              <div class="card-body p-md-5 mx-md-4">
                ...
                <div class="text-center">
                  <img src="./assets/logo_sepatu.png" style="width: 185px;" alt="logo">
                    <div class= "judul">
                      <h4 class="mt-1 mb-5 pb-1">Sneaker Studio</h4>
                    </div>
                </div>

                <form method="POST" action="proses_login.php">
                  <h4 class="login" >LOGIN ACCOUNT</h1>
                  ...
                  <div class="text-center pt-1 mb-1">
                    <button class="btn btn-secondary btn-block fa-lg gradient-custom-2 mb-3 " type="submit" name="login">Login</button>
                    <br>
                  </div>
            ...
            <div class="col-lg-6 ">
              <img src="./assets/logo_login.png" alt="" width="480px" height="710px">
            </div>
          </div>
        </div>
      </div>
