        ...
        <div class="card mb-3" style="border-radius: .5rem;">
          <div class="row g-0">
            <div class="col-md-4 gradient-custom text-center text-white"
              ...
              <img src="./assets/logo_profile.png"alt="Avatar" class="img-fluid my-5" style="width: 100px; height:90px" />
              <h5>Marie Horwitz</h5>
              <p>Web Designer</p>
        ...
        <div class="card">
            ...
            <table class="table">
                ...
                <tbody>
                     <?php 
                    include "../connection.php";
                    $query_pembeli = mysqli_query($conn, "SELECT * FROM transaksi 
                    where id_pembeli = '".$_SESSION['id_pembeli']."' ORDER BY id_transaksi DESC");
                    $no=0;
                    ...
                    <tr>
                        <td><?=$no?></td>
                        <td><?=$data_pembeli['tgl_transaksi']?></td>
                        <td><?=$data_pembeli['tgl_tiba']?></td>
                        <td>
                            <ol>
                            <?php
                            include "../connection.php";
                            $query_detail = mysqli_query($conn, "SELECT * FROM detail_transaksi d
                                            ...
                                            id_transaksi = '".$data_pembeli['id_transaksi']."'");
                        ...
                        <?php
                            ...
                            WHERE id_transaksi = '".$data_pembeli['id_transaksi']."'");
                        ...
                        <td>
                          <?php 
                          echo "<label class='alert alert-success'>".$data_pembeli['status']."</label>";
                          if ($data_pembeli['status'] = "New") {
                           echo "<label class='alert alert-secondary'>".$data_pembeli['status']."</label>";
                          } else if ($data_pembeli['status'] = "Confirm"){
                            echo "<label class='alert alert-primary'>".$data_pembeli['status']."</label>";
                          }
                          ?>
                        </td>                                                
                    </tr>
