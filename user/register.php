          ...
          <div class="row g-0">
            <div class="col-lg-6">
              ...
              <div class="form-row">
                <div class="col-lg-7">
                  <!-- Password -->
                  <input type="password" class="form-control my-2 p-2" name="pasword" placeholder="********" required>
                </div>
              </div>
              <div class="form-row">
                <div class="col-lg-7">
                  <!-- Password -->
                  <input type="password" class="form-control my-2 p-2" name="pasword2" placeholder="********" required>
                </div>
              </div>
              <div class="form-row">
                <div class="col-lg-7">
