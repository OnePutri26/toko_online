<?php 
    ...
    if (isset($_POST["login"])){
        ...
        $qry_login=mysqli_query($conn, "SELECT * FROM pembeli WHERE username = '$username'");
        ...
        if(mysqli_num_rows($qry_login) > 0){
            ...
            */
            ...
            /* Menyamakan data */
            $_SESSION["id_pembeli"]=$dt_login["id_pembeli"];
            $_SESSION["nama_pemmbeli"]=$dt_login["nama_pembeli"];
        ...
        echo "<script>alert('register'); location.href='register.php';</script>";
