...
if($_POST){
    ...
    $no_tlp = strtolower(stripslashes($_POST["no_tlp"]));
    ...
    */
    ...
    $insert=mysqli_query($conn,"insert into pembeli (nama_pembeli, alamat, no_tlp, username, password) value ('".$nama."','".$alamat."','".$no_tlp."','".$username."','".md5($password)."')") or die(mysqli_error($conn));
