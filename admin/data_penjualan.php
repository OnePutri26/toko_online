        ...
        <div class='card-body'>
            <table class="table table-bordered fs-5 fw-light text-center">
                ...
                if (isset($_POST["cari"])) {
                    ...
                    $cari=$_POST['cari'];
                    $query_transaksi= mysqli_query($conn,"SELECT * from transaksi join pembeli on pembeli.id_pembeli= transaksi. id_pembeli join detail_transaksi on detail_transaksi. id_transaksi=transaksi.id_transaksi join produk on produk. id_produk= detail_transaksi.id_produk where pembeli.nama LIKE ".$_GET['cari']." group by nama ORDER BY id_detail_transaksi DESC");
                }else{
                ...
                while($data_transaksi= mysqli_fetch_array($query_transaksi)) {
                    ...
                    <tr>
                        ...
                        <td><img src="./assets/<?=$data_transaksi['foto']?>" class="img-fluid rounded-start" width="150px" height="150px" alt="..." ></td>
