    ...
    <div class="container my-3">
        <div class="card">
            <div class="card-header">
                <h3 class="text-center mt-2 mb-3">Data barang<h3>
                    ...
                    <tbody>
                        <?php
                            ...
                            if (isset($_POST["cari"])) {
                                ...
                                $cari=$_POST['cari'];
                                $query_barang= mysqli_query($conn,"SELECT * FROM barang WHERE id_barang LIKE '%$cari%' OR nama_barang LIKE '%$cari%' OR kategori LIKE '%$cari%'");
                            }else{
                            ...
                            while($data_barang= mysqli_fetch_assoc($query_barang)) { ?>
                                <tr>
                                    ...
                                    <td><img src="<?= "./assets/".$data_barang['foto']; ?>" width='150' height='150'></td>
                                    <td> <a href="ubah_barang.php?id_barang=<?=$data_barang['id_barang']?>" ><i class="fa-solid fa-pen-to-square"></i></a> | <a href="hapus_barang.php?id_barang=<?=$data_barang['id_barang']?>" onclick="return confirm ('Apakah anda yakin menghapus data ini?')" ><i class="fa-solid fa-trash"></i></a></td>
                                </tr>
                            <?php
                            }
                            ?>
