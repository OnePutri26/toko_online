    ...
    <div class="card">
        <div class="card-header">
            <h3 class="mt-2 mb-3 text-center">Data penjualan<h3>
                    <form action="tampil_penjualan.php" method="post">
        ...
        <div class='card-body'>
            <table class="table table-bordered fs-5 fw-light text-center">
                ...
                <tr>
                    <th scope="col">ID</th>
                    <th scope="col">Nama pengguna</th>eksi
                ...
                if (isset($_POST["cari"])) {
                    ...
                    $cari=$_POST['cari'];
                    $query_transaksi= mysqli_query($conn,"SELECT * from transaksi where id_transaksi like '%$cari%' or id_pengguna like '%$cari%' or tanggal_transaksi like '%$cari%'");
                }else{
                    //jika tidak ada keyword pencarian
                    $query_transaksi= mysqli_query($conn,"SELECT * from transaksi join pengguna on pengguna.id_pengguna= transaksi. id_pengguna join detail_transaksi on detail_transaksi. id_transaksi=transaksi.id_transaksi join produk on produk. id_produk= detail_transaksi.id_produk  group by nama ORDER BY id_detail_transaksi DESC ") or die (mysqli_error($connection));
                }
                    $no=0;
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            ?>
                                <img src="./assets/<?=$data_detail['foto']?>" class="img-fluid rounded-start" width="150px" height="150px" alt="..." >
                        ...
                        <?php
                            include "connection.php";
                            $query_bayar = mysqli_query($connection, "SELECT SUM(subtotal) AS total FROM detail_transaksi
