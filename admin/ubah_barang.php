...
<body>
    ...
    <div class="container">
        <div class="content my-3">
            ...
            <form action="proses_ubah_barang.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-2">
                    ...
                    <input type="number" name="harga" class="form-control" value="<?=$dt_barang['harga']?>" placeholder="Masukkan Harga barang" required>
                </div>
                ...
                <div class="mb-2">
                    ...
                    <div>
                        <img src="./assets/<?php echo $dt_barang['foto']; ?>" width="100px">
                    </div>
                </div>
                <!-- Foto barang -->
                <div class="mb-4">
